...
(custom-theme-set-faces
 ...
 `(magit-diff-added ((t (:extend t :foreground "black" :background "#ddffdd"))))
 `(magit-diff-added-highlight ((t (:extend t :foreground "black" :background "#cceecc"))))
 ...
 `(magit-diff-removed ((t (:extend t :foreground "black" :background "#ffdddd"))))
 `(magit-diff-removed-highlight ((t (:extend t :foreground "black" :background "#eecccc"))))
 ...
 `(sldb-catch-tag-face ((t (:inherit highlight))))
 `(sldb-condition-face ((t (:inherit font-lock-warning-face))))
 `(sldb-detailed-frame-line-face ((t nil)))
 `(sldb-frame-label-face ((t (:inherit shadow))))
 `(sldb-frame-line-face ((t nil)))
 `(sldb-local-name-face ((t (:inherit font-lock-variable-name-face))))
 ...
 `(sldb-restart-type-face ((t (:inherit font-lock-keyword-face))))
 `(sldb-restartable-frame-line-face ((t (:foreground "lime green"))))
 `(sldb-section-face ((t (:inherit header-line))))
 `(sldb-topline-face ((t nil)))
 `(slime-apropos-label ((t (:inherit apropos-button))))
 `(slime-apropos-symbol ((t (:inherit apropos-symbol))))
 `(slime-early-deprecation-warning-face ((t (:strike-through "brown"))))
 `(slime-error-face ((t (:underline "red"))))
 `(slime-final-deprecation-warning-face ((t (:strike-through "red"))))
 `(slime-highlight-face ((t (:underline nil :inherit highlight))))
 `(slime-inspector-action-face ((t (:inherit font-lock-warning-face))))
 `(slime-inspector-label-face ((t (:inherit font-lock-constant-face))))
 `(slime-inspector-topline-face ((t nil)))
 `(slime-inspector-type-face ((t (:inherit font-lock-type-face))))
 `(slime-inspector-value-face ((t (:inherit font-lock-builtin-face))))
 `(slime-late-deprecation-warning-face ((t (:strike-through "orange"))))
 `(slime-note-face ((t (:underline "brown4"))))
 `(slime-reader-conditional-face ((t (:inherit font-lock-comment-face))))
 ...
 `(slime-repl-output-mouseover-face ((t (:box (:line-width 1 :color "black" :style released-button) :inherit slime-repl-inputed-output-face))))
 `(slime-repl-prompt-face ((t (:inherit font-lock-keyword-face))))
