...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   `(mode-line-inactive ((,class (:background "gray90" :foreground "gray20" :box "gray50"))))
   ...
   ;; font-lock
   `(font-lock-comment-face ((,class (:foreground "Firebrick"))))
   `(font-lock-comment-delimiter-face ((,class (:inherit font-lock-comment-face))))
   `(font-lock-string-face ((,class (:foreground "forest green"))))
   ...
   `(magit-section-heading ((,class (:weight bold :extend t :foreground "DarkGoldenrod4"))))
   ...
   `(transient-separator ((,class (:extend t :background "grey80"))))
   ...
   `(smerge-upper ((,class (:extend t :background "#ffdddd"))))
   `(smerge-lower ((,class (:extend t :background "#ddffdd"))))
   `(smerge-base ((,class (:extend t :background "#ffffaa"))))
   `(smerge-markers ((,class (:extend t :background "grey85"))))
   ...
   `(magit-diff-file-heading-selection ((,class (:extend t :foreground "salmon4" :inherit magit-diff-file-heading-highlight))))
   `(magit-diff-hunk-heading ((,class (:extend t :foreground "grey20" :background "grey90"))))
   `(magit-diff-hunk-heading-highlight ((,class (:extend t :foreground "grey20" :background "grey80"))))
   `(magit-diff-hunk-heading-selection ((,class (:extend t :foreground "salmon4" :inherit magit-diff-hunk-heading-highlight))))
   ...
   `(magit-diff-lines-heading ((,class (:extend t :background "LightSalmon3" :inherit magit-diff-hunk-heading-highlight))))
   ...
   `(magit-diff-added ((,class (:extend t :foreground "#22aa22" :background "#ddffdd"))))
   `(magit-diff-removed ((,class (:extend t :foreground "#aa2222" :background "#ffdddd"))))
   `(magit-diff-our ((,class (:inherit magit-diff-removed))))
   `(magit-diff-base ((,class (:extend t :foreground "#aaaa11" :background "#ffffcc"))))
   `(magit-diff-their ((,class (:inherit magit-diff-added))))
   `(magit-diff-context ((,class (:extend t :foreground "grey50"))))
   `(magit-diff-added-highlight ((,class (:extend t :foreground "#22aa22" :background "#cceecc"))))
   `(magit-diff-removed-highlight ((,class (:extend t :foreground "#aa2222" :background "#eecccc"))))
   `(magit-diff-our-highlight ((,class (:inherit magit-diff-removed-highlight))))
   `(magit-diff-base-highlight ((,class (:extend t :foreground "#aaaa11" :background "#eeeebb"))))
   `(magit-diff-their-highlight ((,class (:inherit magit-diff-added-highlight))))
   `(magit-diff-context-highlight ((,class (:extend t :foreground "grey50" :background "grey95"))))
   ...
   `(magit-blame-highlight ((,class (:extend t :foreground "black" :background "grey80"))))
