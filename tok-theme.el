...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   `(fill-column-indicator ((,class (:weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :stipple nil :inherit shadow))))
