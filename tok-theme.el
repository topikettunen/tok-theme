...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   `(secondary-selection ((,class (:background "yellow1"))))
   ...
   ;; hl-line
   `(hl-line ((,class (:background "gray15"))))
   ...
   ;; header
   `(header-line ((,class (:box nil :foreground "grey20" :background "grey90" :inherit mode-line))))
   ...
   `(org-column ((,class (:weight normal :slant normal :underline nil :strike-through nil :background "grey90"))))
   ...
   `(org-agenda-structure ((,class (:foreground "Blue1"))))
   ...
   `(org-scheduled ((,class (:foreground "DarkGreen"))))
   `(org-scheduled-today ((,class (:foreground "DarkGreen"))))
   ...
   `(gnus-summary-selected ((,class (:underline t :extend t))))
   `(gnus-summary-cancelled ((,class (:foreground "yellow" :background "black"))))
   `(gnus-summary-normal-ticked ((,class (:foreground "firebrick"))))
   ...
   `(gnus-summary-normal-ancient ((,class (:foreground "RoyalBlue"))))
   ...
   `(gnus-summary-normal-undownloaded ((,class (:weight normal :foreground "cyan4"))))
   ...
   `(gnus-summary-normal-unread ((,class (:extend t))))
   ...
   `(mm-uu-extract ((,class (:foreground "dark green" :background "light yellow"))))
   ...
   ;; diff
   `(diff-header ((,class (:background "grey85"))))
   `(diff-file-header ((,class (:weight bold :background "grey75"))))
   `(diff-index ((,class (:inherit diff-file-header))))
   `(diff-hunk-header ((,class (:inherit diff-header))))
   `(diff-removed ((,class (:background "#ffeeee" :inherit diff-changed))))
   `(diff-added ((,class (:background "#eeffee" :inherit diff-changed))))
   `(diff-changed-unspecified ((,class (:background "grey90" :inherit diff-changed))))
   `(diff-changed ((t (nil))))
